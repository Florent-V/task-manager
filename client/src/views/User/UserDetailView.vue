  ...
  <div class="container mx-auto px-4 py-8">
    ...
    <div v-else>
      ...
      <div class="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-lg dark:shadow-gray-700">
        ...
        <div>
          <div class="flex flex-col md:flex-row">
            ...
            <div class="md:w-1/3 flex justify-center items-center mb-4 md:mb-0">
              <img
                  :src="`${filesApiUrl}/${user.image ?? 'default-product-image.webp'}`"
                  alt="Aperçu"
        ...
        <!--          <div class="mb-4">-->
        <!--            <label class="block text-gray-700 dark:text-gray-300">Photo de profil</label>-->
        <!--            <img :src="userData.picture" alt="Photo de profil" class="mt-2 w-full border border-gray-300 dark:border-gray-600 rounded-lg p-2 bg-white dark:bg-gray-700">-->
        <!--          </div>-->
