        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="relative">
            <select
                ...
                class="border border-gray-300 dark:border-gray-600 pt-6 pb-2 p-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 dark:focus:ring-yellow-400 transition w-full bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
            >
